...
Goed nieuws! Je vraag op VraagHetZe ("{questionTitle}") is geaccepteerd en doorgestuurd naar {politicianName}. Na lancering van ons platform zal je vraag openbaar worden ({@html questionUrl}) en je vindt je vraag ook terug onder "Mijn vragen" in het menu.
