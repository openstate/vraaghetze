<script lang="ts">
  type Props = {
	...
	let { askerName, politicianName, questionTitle, questionUrl }: Props = $props();
</script>
Beste {askerName},

Goed nieuws! Je vraag op VraagHetZe ("{questionTitle}") is geaccepteerd en doorgestuurd naar {politicianName}. Na de officiële lancering van VraagHetZe op 28 september zal je vraag openbaar worden ({@html questionUrl}) en je vindt je vraag ook terug onder "Mijn vragen" in het menu.
